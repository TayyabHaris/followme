 ...
 ''' FOLLOW ME
    ...
    facebook : Follow kro na

    github : tayyabh-haris
 ...
 \x1b[1;101m\x1b[1;97mCreat by : follow kro na  => 12 january 2022\x1b[0m 
 ...
 def menu(): 
         ...
         print ' [%s-10%s] facebook user : %s'%(ml,ra,nama) 

         print ' [%s-10%s] ip user : %s'%(ml,ra,ip) 

         print ' [%s-%s] id user : %s\n'%(ml,ra,id) 

         print ' [%s10%s] Start crack '%(hj,ra) 

         print ' [%s1%s] Delete token '%(ku,ra) 
